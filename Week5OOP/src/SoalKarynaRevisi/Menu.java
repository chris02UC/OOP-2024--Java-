...
public class Menu {
    ...
    System.out.println("\n");
        ...
        System.out.println("");
            if (toprintbank == 1){ // if it is CBA - current user bank
                if (input3 == 1){ // transfer to 
            ...
            if (CBA.getaccount().get(choicetf-1) == a) { //if account same cba
            ...
            break;
                ...
                CBA.getaccount().get(choicetf-1).depositmoney(tfamount); // get acc, choicetf-1, deposit tfamount
                t = new Transaction(); // for sender
                t.setamount(tfamount);
                t.settotal_amount(tfamount);
                t.setbankreceiver(CBA);
                t.setbanksender(CBA);
                t.setsender(a);
                t.setreceiver(CBA.getaccount().get(choicetf-1));
                t.settype("Transferred");
                t.setdesc(adddesc);
                a.addhistory(t);
                t = new Transaction(); // for receiver
                t.setamount(tfamount);
                t.settotal_amount(tfamount);
                t.setbankreceiver(CBA);
                t.setbanksender(CBA);
                ...
                t.settype("Received");
                t.setdesc(adddesc);
                CBA.getaccount().get(choicetf-1).addhistory(t);
            }
            }
            if (input3 == 2){
            ...
            break;
                ...
                t = new Transaction(); // for sender
                t.setamount(tfamount);
                t.settotal_amount(tfamount+4000);
                t.setbankreceiver(DQ);
                t.setbanksender(CBA);
                t.setsender(a);
                t.setreceiver(DQ.getaccount().get(choicetf-1));
                t.settype("Transferred");
                t.setdesc(adddesc);
                a.addhistory(t);
                t = new Transaction(); // for receiver
                ...
                t.settype("Received");
                t.setdesc(adddesc);
                DQ.getaccount().get(choicetf-1).addhistory(t);
            }
            }
            if (input3 == 3){
            ...
            break;
                ...
                t = new Transaction(); // for sender
                t.setamount(tfamount);
                t.settotal_amount(tfamount+10000);
                t.setbankreceiver(PRR);
                t.setbanksender(CBA);
                t.setsender(a);
                t.setreceiver(PRR.getaccount().get(choicetf-1));
                t.settype("Transferred");
                t.setdesc(adddesc);
                a.addhistory(t);
                t = new Transaction(); // for receiver
                ...
                t.settype("Received");
                t.setdesc(adddesc);
                PRR.getaccount().get(choicetf-1).addhistory(t);
            }
            }
            } else if (toprintbank == 2){
                if (input3 == 1){
                ...
                break;
                    ...
                    t = new Transaction(); // for sender
                    t.setamount(tfamount);
                    t.settotal_amount(tfamount+2000);
                    t.setbankreceiver(CBA);
                    t.setbanksender(DQ);
                    t.setsender(a);
                    t.setreceiver(CBA.getaccount().get(choicetf-1));
        ...
        System.out.println("---------------------------------");
            if (a.gethistory().get(y).gettype().equals("Deposit")){
            System.out.println("Deposit");
            System.out.println("Amount Deposited \t\t\t(+) "+a.gethistory().get(y).getamount());
            System.out.println("desc -- "+a.gethistory().get(y).getdesc());
            }
            else if (a.gethistory().get(y).gettype().equals("Withdrawal")){
            System.out.println("Withdrawal");
            System.out.println("Amount Deposited \t\t\t(-) "+a.gethistory().get(y).getamount());
            System.out.println("desc -- "+a.gethistory().get(y).getdesc());
            }
            else if (a.gethistory().get(y).gettype().equals("Transferred")){
            System.out.println("Transferred");
            System.out.println(a.gethistory().get(y).getbankreceiver().getbankname()+" - "+a.gethistory().get(y).getreceiver().getname()+"\t\t\t(-) "+a.gethistory().get(y).getamount());
            System.out.println("Final Total : \t\t\t(-)"+a.gethistory().get(y).gettotal_amount());
            System.out.println("desc -- "+a.gethistory().get(y).getdesc());
            }
            else if (a.gethistory().get(y).gettype().equals("Received")){
            System.out.println("Received");
            System.out.println(a.gethistory().get(y).getbanksender().getbankname()+" - "+a.gethistory().get(y).getsender().getname()+"\t\t\t(+) "+a.gethistory().get(y).getamount());
            System.out.println("desc -- "+a.gethistory().get(y).getdesc());
            }
        System.out.println("---------------------------------");
        }
        ...
        int case5input = s.nextInt();
            ...
            while (!newpin.matches("[0-9]+") || newpin.length() != 6) {
