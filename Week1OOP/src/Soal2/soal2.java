...
public class soal2 {
    ...
    case "5":
    System.out.println("== Rearrange Data ==");
    System.out.println("1. By Name, Ascending\n2. By Name, Descending\n3. By Telephone Number, Ascending\n4. By Telephone Number, Descending");
    System.out.print("Input: ");
    String rd = s.next()+s.nextLine();
        switch (rd) {
        case "1":
        call.ascendname();
    ...
    public void ascendname(){
    ArrayList <String> cnametemp = new ArrayList<String>();
    ArrayList <String> cnumtemp = new ArrayList<String>();
    ArrayList <String> cemailtemp = new ArrayList<String>();
    
    for (int a = 0; a < cname.size(); a++){
    cnametemp.add(cname.get(a));
    cnumtemp.add(cnumber.get(a));
    cemailtemp.add(cemail.get(a));
    }

    Collections.sort(cnametemp);
        for (int a = 0; a < cnametemp.size(); a++){
            for (int b = 0; b < cname.size(); b++){
                if ((cname.get(b)).equals(cnametemp.get(a))){
                String ntemp = cnumber.get(b);
                String nemail = cemail.get(b);
                cnumtemp.set(a, ntemp);
                cemailtemp.set(a, nemail);
                }
            }
        }
    cname = cnametemp;
    ...
    public void descendname(){
        ...
        Collections.sort(cnametemp, Collections.reverseOrder());
            for (int a = 0; a < cnametemp.size(); a++){
                for (int b = 0; b < cname.size(); b++){
                    if ((cname.get(b)).equals(cnametemp.get(a))){
                    String ntemp = cnumber.get(b);
    ...
    Collections.sort(cnumtemp);
        for (int a = 0; a < cnumtemp.size(); a++){
            for (int b = 0; b < cnumber.size(); b++){
                if ((cnumber.get(b)).equals(cnumtemp.get(a))){
                String ntemp = cname.get(b);
                String nemail = cemail.get(b);
                cnametemp.set(a, ntemp);
                cemailtemp.set(a, nemail);
                }
            }
        }
    ...
    public void descendnumber(){
        ...
        Collections.sort(cnumtemp, Collections.reverseOrder());
            for (int a = 0; a < cnumtemp.size(); a++){
                for (int b = 0; b < cnumber.size(); b++){
                    if ((cnumber.get(b)).equals(cnumtemp.get(a))){
                    String ntemp = cname.get(b);
